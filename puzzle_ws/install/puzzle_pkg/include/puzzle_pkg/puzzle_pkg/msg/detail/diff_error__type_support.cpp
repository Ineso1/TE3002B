...
{
  new (message_memory) puzzle_pkg::msg::DiffError(_init);
}

void DiffError_fini_function(void * message_memory)
{
  auto typed_message = static_cast<puzzle_pkg::msg::DiffError *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DiffError_message_member_array[2] = {
  {
    ...
    offsetof(puzzle_pkg::msg::DiffError, error_ang),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(puzzle_pkg::msg::DiffError, error_dist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DiffError_message_members = {
  "puzzle_pkg::msg",  // message namespace
  "DiffError",  // message name
  2,  // number of fields
  sizeof(puzzle_pkg::msg::DiffError),
...
{
  return &::puzzle_pkg::msg::rosidl_typesupport_introspection_cpp::DiffError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puzzle_pkg, msg, DiffError)() {
  return &::puzzle_pkg::msg::rosidl_typesupport_introspection_cpp::DiffError_message_type_support_handle;
}
