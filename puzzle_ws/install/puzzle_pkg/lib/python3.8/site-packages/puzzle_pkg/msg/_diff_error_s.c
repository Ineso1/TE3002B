...
bool puzzle_pkg__msg__diff_error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("puzzle_pkg.msg._diff_error.DiffError", full_classname_dest, 36) == 0);
  }
  puzzle_pkg__msg__DiffError * ros_message = _ros_message;
  {  // error_ang
...
PyObject * puzzle_pkg__msg__diff_error__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("puzzle_pkg.msg._diff_error");
