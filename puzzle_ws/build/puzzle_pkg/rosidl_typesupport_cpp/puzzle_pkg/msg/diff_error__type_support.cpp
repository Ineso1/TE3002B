...
static const _DiffError_type_support_symbol_names_t _DiffError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, puzzle_pkg, msg, DiffError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, puzzle_pkg, msg, DiffError)),
  }
};
...
{
  return &::puzzle_pkg::msg::rosidl_typesupport_cpp::DiffError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, puzzle_pkg, msg, DiffError)() {
  return get_message_type_support_handle<puzzle_pkg::msg::DiffError>();
}
