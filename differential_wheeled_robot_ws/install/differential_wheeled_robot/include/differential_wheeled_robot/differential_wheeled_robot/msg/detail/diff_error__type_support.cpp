...
{
  new (message_memory) differential_wheeled_robot::msg::DiffError(_init);
}

void DiffError_fini_function(void * message_memory)
{
  auto typed_message = static_cast<differential_wheeled_robot::msg::DiffError *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DiffError_message_member_array[2] = {
  {
    ...
    offsetof(differential_wheeled_robot::msg::DiffError, error_ang),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(differential_wheeled_robot::msg::DiffError, error_dist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DiffError_message_members = {
  ...
  2,  // number of fields
  sizeof(differential_wheeled_robot::msg::DiffError),
...
{
  return &::differential_wheeled_robot::msg::rosidl_typesupport_introspection_cpp::DiffError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, differential_wheeled_robot, msg, DiffError)() {
  return &::differential_wheeled_robot::msg::rosidl_typesupport_introspection_cpp::DiffError_message_type_support_handle;
}
