...
#include "differential_wheeled_robot/msg/detail/diff_error__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_differential_wheeled_robot
cdr_serialize(
  const differential_wheeled_robot::msg::DiffError & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  differential_wheeled_robot::msg::DiffError & ros_message)
{
  // Member: error_ang
  cdr >> ros_message.error_ang;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = differential_wheeled_robot::msg::DiffError;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const differential_wheeled_robot::msg::DiffError *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<differential_wheeled_robot::msg::DiffError *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_differential_wheeled_robot
const rosidl_message_type_support_t *
get_message_type_support_handle<differential_wheeled_robot::msg::DiffError>()
{
  return &differential_wheeled_robot::msg::typesupport_fastrtps_cpp::_DiffError__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, differential_wheeled_robot, msg, DiffError)() {
  return &differential_wheeled_robot::msg::typesupport_fastrtps_cpp::_DiffError__handle;
}
