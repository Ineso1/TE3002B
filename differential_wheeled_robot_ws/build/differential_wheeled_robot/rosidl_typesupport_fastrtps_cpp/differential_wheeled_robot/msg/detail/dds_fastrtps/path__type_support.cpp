...
#include "differential_wheeled_robot/msg/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const differential_wheeled_robot::msg::Path & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  differential_wheeled_robot::msg::Path & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = differential_wheeled_robot::msg::Path;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const differential_wheeled_robot::msg::Path *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<differential_wheeled_robot::msg::Path *>(
    untyped_ros_message);
...
{
  return &differential_wheeled_robot::msg::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, differential_wheeled_robot, msg, Path)() {
  return &differential_wheeled_robot::msg::typesupport_fastrtps_cpp::_Path__handle;
}
