...
static const _Path_type_support_symbol_names_t _Path_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, differential_wheeled_robot, msg, Path)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, differential_wheeled_robot, msg, Path)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, differential_wheeled_robot, msg, Path)() {
  return &::differential_wheeled_robot::msg::rosidl_typesupport_c::Path_message_type_support_handle;
}
