...
static const _DiffError_type_support_symbol_names_t _DiffError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, differential_wheeled_robot, msg, DiffError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, differential_wheeled_robot, msg, DiffError)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, differential_wheeled_robot, msg, DiffError)() {
  return &::differential_wheeled_robot::msg::rosidl_typesupport_c::DiffError_message_type_support_handle;
}
