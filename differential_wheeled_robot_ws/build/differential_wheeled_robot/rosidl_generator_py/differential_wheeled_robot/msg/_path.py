...
class Metaclass_Path(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('differential_wheeled_robot')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'differential_wheeled_robot.msg.Path')
            logger.debug(
...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        'data': 'sequence<geometry_msgs/Point>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'Point'"
        self._data = value
