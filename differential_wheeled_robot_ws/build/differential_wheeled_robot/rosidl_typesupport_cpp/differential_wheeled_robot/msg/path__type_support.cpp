...
static const _Path_type_support_symbol_names_t _Path_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, differential_wheeled_robot, msg, Path)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, differential_wheeled_robot, msg, Path)),
  }
};
...
{
  return &::differential_wheeled_robot::msg::rosidl_typesupport_cpp::Path_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, differential_wheeled_robot, msg, Path)() {
  return get_message_type_support_handle<differential_wheeled_robot::msg::Path>();
}
