...
#include "lane_processing/msg/detail/diff_error__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lane_processing::msg::DiffError;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lane_processing::msg::DiffError *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lane_processing::msg::DiffError *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lane_processing
const rosidl_message_type_support_t *
get_message_type_support_handle<lane_processing::msg::DiffError>()
{
  return &lane_processing::msg::typesupport_fastrtps_cpp::_DiffError__handle;
}
